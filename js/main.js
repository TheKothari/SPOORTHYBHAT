...
jQuery(document).ready(function($) {
  ...
  OnePageNavigation();
  var OnePageNavigationScroll = function() {
    var navToggler = $('.site-menu-toggle');
   	$("body").on("click", ".scroll-down a[href^='#'], .smoothscroll[href^='#'], .site-mobile-menu .site-nav-wrap li a", function(e) {
      e.preventDefault();
